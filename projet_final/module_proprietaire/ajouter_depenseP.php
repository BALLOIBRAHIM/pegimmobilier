...
<div class="menu-wrapper">
                ...
                <nav class="nav-menu">
                    <div class="logo">
                        ...
                        if(isset($_SESSION['P_num'])){
                            $pro=recherche_unique("proprietaire","P_num",$proprietaire);
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tagline-message">
                            <h3>créer un contrat <mark class="rotate">Facilement,Simplement,en un clic </mark> </h3>
                            <div class="menu-search">
                                <form>
                                    <div class="form-group">
    ...
    <div class="ajouter_locataire" style="background-color:black;">
                <!-- formulaire d'enregistrement -->
                     <?php include '../php/ajouter_depense.php';?>
