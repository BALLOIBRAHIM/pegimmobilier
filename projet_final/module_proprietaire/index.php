                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Dashbaord </a>
        ...
        <header class="vertical-header">
            <div class="vertical-header-wrapper">
                <nav class="nav-menu">
                    ...
                    <li class="child-menu"><a href="#">Dashbaord</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tagline-message">
                            <h3>PEGIMMOBILIERE c'est <mark class="rotate">Gratuit,Facile,Simple </mark> </h3>
                            <div class="menu-search">
                                <form>
                                    <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="service-box m30">
                            <img src="images/PNG/groupe (1).png" width="30%"/>
                            <h3>les locataires</h3>
                            <p>vous avez <?php 
                             $nbrlocataires=recherche_unique("locataire","locataire.PROPRIETAIRE_P_num",$proprietaires);
                            if(isset($nbrlocataires)){
                               
                            if(count($nbrlocataires)>1)
                            echo count($nbrlocataires)." locataires. ";
                            else
                            echo count($nbrlocataires)." locataire. ";}
                            else{
                                echo " 0 locataire. ";
                            }
                            ?> </p>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="service-box m30">
                            <img src="images/PNG/de-location.png" width="30%"/>
                            <h3>les biens</h3>
                            <p>nombre de biens : <?php 
                             $nbrbiens=recherche_unique("bien","bien.PROPRIETAIRE_P_num",$proprietaires);
                             if(isset($nbrbiens)){
                               
                            if(count($nbrbiens)>1)
                            echo count($nbrbiens)." biens. ";
                            else
                            echo count($nbrbiens)." bien. ";}
                            else{
                                echo " 0 bien. ";
                            }
                            ?> </p>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="service-box m30">
                            <img src="images/PNG/contracter (3).png" width="30%"/>
                            <h3>les contrats</h3>
                            <p>il y'a 
                            <?php 
                   $nbrcontrat=recherche_unique("contrat","contrat.PROPRIETAIRE_P_num",$proprietaires);

                            if(isset($nbrcontrat)){
                                
                            if(count($nbrcontrat)>1)
                            echo count($nbrcontrat)." contrats. ";
                            else
                            echo count($nbrcontrat)." contrat. ";
                            }
                            else{
                                echo " 0 contrat. ";
                            }
