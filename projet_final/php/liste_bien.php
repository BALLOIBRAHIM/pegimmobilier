...
<body style=" background-color:black;" >
	...
	<h2 style="margin-left:350px;margin-top :50px;margin-bottom:50px; color:#ffffff;font-size:4rem;">Mes biens</h2>
<aside class="gestion_groupe" style="padding-bottom:100px;overflow:scroll;">
		
<div class="container">
  							
		<form method="POST" action="">
				<table border="1" class="table table-dark table-hover  table-striped" width="700px" height="500px" align="center" cellpadding="2px" cellspacing="0px"  >
				<tr>
				...
				<tr>
					...
					<?php echo $affiche['B_nom'];?>
					</td>
					<td width="300px" height="90px">
					<?php echo $affiche['B_ref1'];?>
					</td>
					<td width="300px" height="90px">
					<?php echo $affiche['B_ref2'];?>
					</td>
					<td width="300px" height="90px">
					<?php echo $affiche['B_ref3'];?>
					</td>
					<td width="300px" height="90px">
					<?php echo $affiche['B_ref4'];?>
					</td>
					
					<td width="200px" height="40px" >
					<table border="1" width="100px" cellspacing="0" cellpadding="0"><tr><td>
						<a href="supprimer_bien.php?  x=<?php echo $affiche['B_num']?>" >
						 ...
						 <a href="modifier_bien.php?  x=<?php echo $affiche['B_num'];?>" >
