...
$pwd=$_POST['pwd'];
$req="INSERT INTO `proprietaire` (`P_num`, `P_nom`, `P_prenom`, `P_datenais`, `P_lieunais`, `P_email`, `P_contact`, `P_desc`, `P_pwd`, `P_nom_complet`) VALUES ('$email_p', NULL, NULL, NULL, NULL, '$email_p', NULL, NULL, '$pwd', '$nomcomplet');";

$pre=$cnx->prepare($req);

$ex=$pre->execute(array());
$_SESSION['P_num']=$email_p;
